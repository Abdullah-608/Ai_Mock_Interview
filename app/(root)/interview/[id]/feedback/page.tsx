  ...
  return (
    <section className="section-feedback max-w-4xl mx-auto px-4 py-8 animate-fadeIn">
      ...
      <div className="buttons flex justify-center gap-4 mt-8">
        ...
        <Button className="btn-primary bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 animate-pulse-slow">
          <Link href={`/interview/${id}`} className="flex w-full justify-center">
            <p className="text-sm font-semibold text-center flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
